...
Commands and results, including limitations. `python3 tests/validate.py` and `python3 -m unittest discover -s tests -p 'test_*.py'`; include proposal field-inventory checks where applicable.
